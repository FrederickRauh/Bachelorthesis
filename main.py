...
# # # # # # # # # # # Single Process # # # # # # # # # #
# dataframe_psf_path = dm.get_all_data_path() + '\\' + 'psf-dataframe.json'
# dataframe_psf = dam.load_dataframe_from_path(dataframe_psf_path)
# trainer.train_multi_svm(speaker_ids, dataframe_psf, feature_type='psf')
# trainer.train_multi_gmm(speaker_ids, dataframe_psf, feature_type='psf')
