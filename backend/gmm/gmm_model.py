...
from utils.config import MODELCONFIG, FEATURES
...
#     logging.debug("Training gmm_model with ", feature_type, " features for:", speaker_id, ":: There are:", len(training_features),
#           " trainingfiles. Start at: ", start_time)
#
#     n_components = [FEATURES.N_MFCC]
#     # [13, 16]
#     max_iter = [200]
