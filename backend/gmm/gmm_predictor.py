...
from utils import audioManager as am, directoryManager as dm, resultManager as rm, util
from utils.config import IDS, FEATURES, SYSTEM
...
#
#     def predict_n_speakers_gmm(self, speaker_ids, feature_type, mfcc):
...
#             logging.debug("GMM ::  predicting for:", speaker_id, "files:", len(test_files), " feature_type: ", feature_type)
